...
- `AETHER_OLLAMA_URL=http://127.0.0.1:11434/api/generate` for native host runs; in containers the sidecar auto-tries `host.docker.internal`, `gateway.docker.internal`, `host.containers.internal`, and detected Linux bridge gateway IPs.
